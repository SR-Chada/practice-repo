package com.macnicagwi.globalportal.core.services.impl;
...
import com.macnicagwi.globalportal.core.constants.GlobalPortalCoreConstants;
...
public class JcrSearchServiceImpl implements JcrSearchService {
    ...
    public List<Resource> getResources(Map<String, String> predicates, Session session) {
        if (StringUtils.isBlank(predicates.get(GlobalPortalCoreConstants.SEARCH_PATH))) {
