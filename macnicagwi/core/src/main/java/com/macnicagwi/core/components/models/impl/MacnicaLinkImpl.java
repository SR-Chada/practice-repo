...
public class MacnicaLinkImpl<T> implements Link<T>  {
    ...
    public MacnicaLinkImpl(@Nullable String url, @Nullable String mappedUrl, @Nullable String externalizedUrl, @Nullable T reference,
