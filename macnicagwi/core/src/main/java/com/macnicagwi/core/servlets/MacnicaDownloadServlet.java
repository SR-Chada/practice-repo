...
@Component(
       ...
       property = {
               ...
               "sling.servlet.selectors=" + MacnicaDownloadServlet.SELECTOR
       }
)
public class MacnicaDownloadServlet extends SlingAllMethodsServlet {

   private static final long serialVersionUID = 1L;
   private static final Logger LOG = LoggerFactory.getLogger(MacnicaDownloadServlet.class);
   public static final String SELECTOR = "macnicadownload";
   ...
   protected void doGet(@NotNull SlingHttpServletRequest request, @NotNull SlingHttpServletResponse response)
           throws IOException {
       LOG.trace("Received request to download Macnica Asset. Servlet path {}", request.getServletPath());
       Asset asset = request.getResource().adaptTo(Asset.class);
       if (asset == null) {
           LOG.trace("Download resource is not of type asset. Resource type {}", request.getResource().getResourceType());
           ...
           LOG.trace("Download resource is of type asset.");
       ...
       if (Collections.list(request.getHeaderNames()).contains(HttpConstants.HEADER_IF_MODIFIED_SINCE)) {
           ...
           if (StringUtils.isNotEmpty(headerDate)) {
               ...
               try {
                   ...
                   // do nothing
                   LOG.error("ParseException in Macnica Download Servlet {}",e);
               }
           }
       }
       return match;
